...
public class ContactActivity extends AppCompatActivity {
    ...
    BootstrapButton bt_check_upgrade;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_check_upgrade = (BootstrapButton) findViewById(R.id.bt_check_upgrade);
        ...
        bt_check_upgrade.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
